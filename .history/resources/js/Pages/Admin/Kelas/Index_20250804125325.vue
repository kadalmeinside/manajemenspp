...
const form = useForm({
    ...
    biaya_pendaftaran: null, // <-- Field baru
});
...
const openEditModal = (kelasItem) => {
    ...
    form.biaya_pendaftaran = kelasItem.biaya_pendaftaran; // <-- Mengisi data baru
    showKelasModal.value = true;
};
            ...
            <div class="p-6">
                ...
                <form @submit.prevent="submitKelasForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <TextInput id="kelas_biaya_pendaftaran_modal" type="number" step="1000" class="mt-1 block w-full" v-model="form.biaya_pendaftaran" placeholder="Contoh: 1500000" />
