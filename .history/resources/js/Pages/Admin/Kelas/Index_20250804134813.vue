...
// ### PERBAIKAN: Computed property untuk formatting input Rupiah ###
            ...
            <div class="p-6">
                ...
                <form @submit.prevent="submitKelasForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <!-- ### PERBAIKAN: Menggunakan v-model pada computed property ### -->
                        <TextInput id="kelas_biaya_pendaftaran_modal" type="text" class="mt-1 block w-full" v-model="biayaPendaftaranFormatted" placeholder="Contoh: 1.500.000" />
                    ...
                    <div>
                        ...
                        <!-- ### PERBAIKAN: Menggunakan v-model pada computed property ### -->
                        <TextInput id="kelas_biaya_spp_modal" type="text" class="mt-1 block w-full" v-model="biayaSppFormatted" placeholder="Contoh: 300.000" />
