    ...
    <GuestLayout>
        ...
        <div class="w-full max-w-md rounded-xl bg-white p-4 dark:bg-slate-800">
            ...
            <p class="mt-10 text-center text-sm text-gray-600 dark:text-gray-400">
                Ada masalah saat Login ? Atau Password tidak bisa reset ?
                <span class="font-semibold text-indigo-600 dark:text-indigo-400">
                    Hubungi Kami di sini +62 811-386-846
                </span>
                <a href="https://wa.me/62811386846" 
                target="_blank" 
                rel="noopener noreferrer" 
                class="ml-2 inline-flex items-center justify-center rounded-full bg-green-500 p-1.5 text-white align-middle transition hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
