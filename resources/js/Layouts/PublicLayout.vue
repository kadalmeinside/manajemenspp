...
<template>
    <div class="bg-white dark:bg-zinc-900 text-black/80 dark:text-white/80">
        ...
        <transition name="fade">
            <div v-if="isLoading" class="fixed inset-0 flex items-center justify-center z-[100] loading-overlay">
                ...
                <div>
                    <h3 class="font-bold text-white">Media Sosial</h3>
                     <div class="mt-4 flex flex-col space-y-2 items-start">
                         ...
                         <a href="https://www.youtube.com/c/PersijaTV" target="_blank" rel="noopener" class="flex items-center hover:text-white transition-colors">
