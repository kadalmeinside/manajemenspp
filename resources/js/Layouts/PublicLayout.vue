...
const headerClass = computed(() => {
    ...
    // Jika halaman saat ini BUKAN 'Welcome', selalu gunakan background solid.
    if (page.component !== 'Welcome') {
        return `${baseClasses} ${solidBgClasses}`;
    }
    
    // Jika halaman saat ini ADALAH 'Welcome', gunakan background solid HANYA jika di-scroll.
...
<template>
    <div class="bg-white dark:bg-zinc-900 text-black/80 dark:text-white/80">
        <!-- PERBAIKAN: :class sekarang dinamis -->
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-2">
                        ...
                        <Link :href="route('tagihan.check_form')" class="bg-white  text-gray-900 font-bold py-2 px-5 rounded-md text-sm hover:bg-red-500 transition-colors">Bayar SPP</Link>
                    </div>
