                ...
                <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            disabled  
                        >
                            <option :value="props.academyClass.id_kelas">
                                {{ props.academyClass.nama_kelas }}
                            </option>
                        </select>
