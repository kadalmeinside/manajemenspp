...
const biayaNormal = ref(props.academyClass.biaya_pendaftaran_normal);
const biayaSetelahPromoOtomatis = ref(props.academyClass.biaya_pendaftaran_saat_ini);
const biayaSaatIni = ref(props.academyClass.biaya_pendaftaran_saat_ini);
...
// Computed property untuk menghitung jumlah diskon
...
const applyPromoCode = async () => {
    if (!inputKodePromo.value) return;
        ...
        <form v-if="!flash?.success" @submit.prevent="submit" novalidate class="space-y-6">
            ...
            <div v-show="currentStep === 1" class="pt-2">
                ...
                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div>
                        <InputLabel for="id_kelas" value="Kelas Akademi" />
                        <select id="id_kelas" v-model="form.id_kelas" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 rounded-md shadow-sm" disabled>
                            <option :value="props.academyClass.id_kelas">{{ props.academyClass.nama_kelas }}</option>
                        </select>
            ...
            <div v-show="currentStep === 2" class="pt-2">
                ...
                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div>
                        ...
                        <TextInput id="nomor_telepon_wali" v-model="form.nomor_telepon_wali" type="tel" class="mt-1 block w-full" placeholder="Cth: 081234567890" required />
                    ...
                    <div v-if="!emailExists">
                        ...
                        <TextInput id="user_password_confirmation" v-model="form.user_password_confirmation" type="password" class="mt-1 block w-full" placeholder="••••••••" required />
