...
<template>
    ...
    <div class="relative min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center p-4 sm:p-6 overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute -top-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-br from-yellow-400/20 to-orange-500/5 blur-3xl opacity-50 dark:opacity-20 animate-pulse-slow"></div>
            <div class="absolute -bottom-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tr from-amber-400/20 to-red-500/5 blur-3xl opacity-50 dark:opacity-20 animate-pulse-slow" style="animation-delay: 2s;"></div>
        </div>
        ...
        <main class="w-full max-w-lg mx-auto z-10 text-center transition-all duration-1000 ease-out transform" :class="showContent ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'">
            <!-- Success Card -->
            <div class="bg-white dark:bg-gray-800 shadow-2xl shadow-yellow-500/10 dark:shadow-yellow-900/20 rounded-3xl p-8 sm:p-12 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
                ...
                <div class="relative mx-auto w-24 h-24 mb-8">
                    <div class="absolute inset-0 bg-yellow-100 dark:bg-yellow-900/30 rounded-full scale-150 animate-ping opacity-20"></div>
                    <div class="relative flex items-center justify-center w-full h-full bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full shadow-lg shadow-yellow-500/30 transform transition-transform duration-700" :class="showContent ? 'scale-100 rotate-0' : 'scale-0 -rotate-180'">
                ...
                <p class="text-gray-500 dark:text-gray-400 leading-relaxed mb-6">
                    Pendaftaran untuk <strong class="text-gray-900 dark:text-white font-semibold">{{ siswaName }}</strong> (Cabang: <strong class="text-gray-900 dark:text-white font-semibold">{{ cabangName }}</strong>) telah tercatat di sistem kami.
                </p>

                <!-- Next Steps Info -->
                <div class="mb-6 text-left bg-gray-50 dark:bg-gray-700/50 p-5 rounded-2xl border border-gray-100 dark:border-gray-700">
                    <div class="flex flex-col gap-1 mb-2">
                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Langkah Selanjutnya</span>
                        <span class="text-sm text-gray-900 dark:text-white font-medium">Silakan selesaikan pembayaran pendaftaran Anda. Data siswa dan akun akses akan dibuat secara otomatis setelah pembayaran sukses diverifikasi.</span>
                    </div>
                </div>
